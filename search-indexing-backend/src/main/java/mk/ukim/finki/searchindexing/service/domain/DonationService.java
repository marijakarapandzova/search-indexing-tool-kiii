...
public interface DonationService {
    ...
    /**
     * Creates a DRAFT batch from already-indexed documents.
     * Throws {@code DocumentNotFoundException} when an id does not exist.
     */
    DonationBatch createBatch(List<Long> documentIds);
