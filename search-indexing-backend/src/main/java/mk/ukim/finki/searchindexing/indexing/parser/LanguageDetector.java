 ...
 * project is to index and donate <i>Macedonian</i> content to doniraj.vezilka.ai.
 *
 * <p>TODO(student): Provide an implementation. Options include a language
 * detection library, a heuristic over the Cyrillic script combined with
 * Macedonian-specific letters (ѓ, ќ, ѕ, џ, љ, њ), or a small classifier.</p>
 */
